...
public class SendMailTest {
    ...
    // 发件人
    private static String from = "714586750@qq.com";

    // 收件人
    private static String to = "714586750@qq.com";
    ...
    public static void main(String[] args) throws Exception {
        String content = RegisterMail.getRegisterMailMessage("高少宇", "https://www.kanzhun.com/account/emailValidate?account=714586750@qq.com&code=hzFmyLMvrZvGZwfjP8LiiGKU1KZ0NsK2");
        EmailHelper.sendEmail("sdfsdfsd@163.com", "艺扬艺术衫注册验证", content);
//        // 发送文本邮件
//        sendTextEmail();

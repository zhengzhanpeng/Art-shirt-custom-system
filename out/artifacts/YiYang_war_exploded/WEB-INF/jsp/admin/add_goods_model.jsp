...
<div>
    ...
    <form class="add-user layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">服装地址</label>
            <div class="layui-input-inline">
                <input type="text" id="address" name="address" required lay-verify="required" placeholder="上传图片后自动获取"
                       disabled autocomplete="off" class="layui-input input-length-m">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">背面地址</label>
            <div class="layui-input-inline">
                <input type="text" id="backAddress" name="address" required lay-verify="required" placeholder="上传图片后自动获取"
                       disabled autocomplete="off" class="layui-input input-length-m">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">服装上传</label>
            <div class="layui-input-block">
                <input type="file" id="front" name="file" class="layui-upload-file">
                <input type="file" id="back" name="file" class="layui-upload-file">
            </div>
        </div>

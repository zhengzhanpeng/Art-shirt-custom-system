    ...
    <fieldset class="layui-elem-field">
        ...
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="title" id="password" placeholder="请输入新密码(6-20位的字母或数字)"
                           class="layui-input">
                </div>
            ...
            $.ajax({
                ...
                "success": function (response) {
                    if (response == "1") {
                        ...
                        setTimeout("window.parent.location.href = 'j_spring_security_logout'", 800);
                    }
                    else {

...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav admin-header-item">
                ...
                <li class="layui-nav-item"><a href="javascript:;"
                                              class="admin-header-user"> <img src="images/0.jpg" /> <span>发货员：${user.name}&nbsp;</span>
                </a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;"><i class="fa fa-user-circle"
                                                      aria-hidden="true"></i> 业务信息</a>
                        </dd>
                        <dd>
                        ...
                        <dd>
                            <a href="j_spring_security_logout"><i class="fa fa-sign-out"
    ...
    <div class="layui-body"
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief"
            ...
            <div class="layui-tab-content"
                 style="min-height: 510px; padding: 5px 0 0 0;">
    ...
    <script type="text/template" id="lock-temp">
        <div class="admin-header-lock" id="lock-box">
            ...
            <div class="admin-header-lock-name" id="lockUserName">艺扬服装</div>
    ...
    <script type="text/javascript" src="datas/nav_sender.js"></script>
